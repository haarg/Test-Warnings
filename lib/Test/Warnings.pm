...
our @EXPORT_OK = qw(allow_warnings allowing_warnings had_no_warnings warnings);
...
closer to a L<Test::Fatal>-like syntax -- tentatively done now, see
C<warnings> above, and C<examples/test_warning_contents.t> in this
distribution.
